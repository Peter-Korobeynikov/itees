...
<head>
    ...
    <style type="text/css">
        body{
            background:url(/public/errors/images/bg.png);
            margin:0;
...
<img src="/public/errors/images/label.png" class="w3l-logo"/>
<div class="wrap">
    <div class="logo">
        <img src="/public/errors/images/woody-404.png" class="w3l-logo1"/>
        <div class="sub">
